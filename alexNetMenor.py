...
model = Sequential([
    Conv2D(48, (11, 11), strides=(4, 4), activation='relu', input_shape=input_shape),
...
checkpoint_callback_keras = ModelCheckpoint(
    filepath='./modelosNeurais/modelos_AlexNet.keras',
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
checkpoint_callback_h5 = ModelCheckpoint(
    filepath='./modelosNeurais/modelos_AlexNet.h5',
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
plt.xlabel('Classe')
plt.ylabel('Recall')
plt.title('Recall por Classe - AlexNet')
plt.show()
...
plt.xlabel('Classe')
plt.ylabel('F1-score')
plt.title('F1-score por Classe - AlexNet')
plt.show()
...
with open('./modelosNeurais/modelos_AlexNet.pkl', 'wb') as file:
